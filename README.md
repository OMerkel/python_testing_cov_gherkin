...
There we are using Gherkin for Test Specs in Python comments. This will enable Test or Code Reviewers to compare
implemented functional code with test code and the test specification (even if perhaps no
Behaviour Driven Development (BDD) is performed or intended in your target project).
